...
// normalizedIdentifier returns the backup identifier only if it is a valid,
// lowercase UUID. This prevents path traversal via crafted identifiers.
...
// validateIdentifier ensures the backup identifier is a valid UUID and
